...
GCP 서버 문제로 현재 NCP 임시 서버에서 제한 운영 중입니다. 이번 테스트에서는 6개 핵심 법령을 제공하며, 한 질문마다 관련성이 높은 법령 URL 최대 4개와 첨부파일 최대 2개만 확인합니다.

가능한 체험
- 핵심 법령의 적용 순서와 검토 항목 정리
- 건폐율·용적률·피난·방화·주차 관련 기본 체크리스트 작성
- 질문에 필요한 대상지·용도·규모 등 추가정보 안내
- 웹 검색을 켠 경우 최신 공개자료와 출처 확인

주소 자동조회·법정 기준 계산·사업성 분석은 외부 FastAPI 상태에 따라 지연되거나 실패할 수 있습니다.
